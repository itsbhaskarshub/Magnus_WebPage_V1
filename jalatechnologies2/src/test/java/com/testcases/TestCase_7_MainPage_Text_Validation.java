...
public class TestCase_7_MainPage_Text_Validation{
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		 ...
		 */
		Thread.sleep(5000);	
		WebElement Main_WebPage_Title = driver.findElement(By.xpath("//*[contains(text(),'projects')]"));
		
		String text_form_Page = Main_WebPage_Title.getText();
		 String[] only_Text = text_form_Page.split(":");
